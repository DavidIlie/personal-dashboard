...
const NewsModuleModal = ({ isOpen, updateModalState }: Props): JSX.Element => {
    const { updateSettings, settings } = useSettingsStore();

    const RemoveKey = async () => {
        const r = await fetch("/api/first/modules/news", {
            method: "DELETE",
        });
        ...
        >
            <>
                ...
                <Formik
                    ...
                    initialValues={{ api_key: settings.newsKey || "" }}
...
export default NewsModuleModal;
